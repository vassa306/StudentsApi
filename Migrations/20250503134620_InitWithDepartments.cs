...
{
    /// <inheritdoc />
    public partial class InitWithDepartments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "Id", "Address", "DepartmentId", "Email", "Name" },
                values: new object[,]
                {
                    { 1, "123 Main St, Prague", null, "john.doe@seznam.cz", "John" },
                    { 2, "456 Elm St, Brno", null, "jane.smith@gmail.com", "Jane" }
                });
